    ...
    <section id="home" className="relative h-screen min-h-[700px] overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        >
          <a
            href="#rooms"
            className="rounded-sm bg-gold px-8 py-3.5 text-xs font-semibold tracking-widest text-accent-foreground uppercase transition-all hover:bg-gold-dark hover:shadow-lg"
          >
            Explore Rooms
          </a>
          <a
            href="#contact"
            className="rounded-sm border border-accent-foreground/30 px-8 py-3.5 text-xs font-semibold tracking-widest text-accent-foreground uppercase transition-all hover:border-gold hover:text-gold"
          >
            Contact Us
          </a>
        </motion.div>
